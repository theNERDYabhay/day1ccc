"use strict";(globalThis.webpackChunk_github_ui_github_ui=globalThis.webpackChunk_github_ui_github_ui||[]).push([["vendors-node_modules_lit-labs_react_index_js-node_modules_tanstack_react-virtual_dist_esm_index_js"],{37732:(e,t,s)=>{s.d(t,{a:()=>o});let i=new Set(["children","localName","ref","style","className"]),n=new WeakMap,l=(e,t,s,i,l)=>{let o=null==l?void 0:l[t];void 0===o||s===i?null==s&&t in HTMLElement.prototype?e.removeAttribute(t):e[t]=s:((e,t,s)=>{let i=n.get(e);void 0===i&&n.set(e,i=new Map);let l=i.get(t);void 0!==s?void 0===l?(i.set(t,l={handleEvent:s}),e.addEventListener(t,l)):l.handleEvent=s:void 0!==l&&(i.delete(t),e.removeEventListener(t,l))})(e,o,s)};function o(e=window.React,t,s,n,r){let h,a,u;void 0===t?({tagName:a,elementClass:u,events:n,displayName:r}=e,h=e.react):(h=e,u=s,a=t);let d=h.Component,c=h.createElement,m=new Set(Object.keys(null!=n?n:{}));let v=class v extends d{constructor(){super(...arguments),this.o=null}t(e){if(null!==this.o)for(let t in this.i)l(this.o,t,this.props[t],e?e[t]:void 0,n)}componentDidMount(){var e;this.t(),null==(e=this.o)||e.removeAttribute("defer-hydration")}componentDidUpdate(e){this.t(e)}render(){let{_$Gl:e,...t}=this.props;this.h!==e&&(this.u=t=>{null!==e&&("function"==typeof e?e(t):e.current=t),this.o=t,this.h=e}),this.i={};let s={ref:this.u};for(let[e,n]of Object.entries(t))i.has(e)?s["className"===e?"class":e]=n:m.has(e)||e in u.prototype?this.i[e]=n:s[e]=n;return s.suppressHydrationWarning=!0,c(a,s)}};v.displayName=null!=r?r:u.name;let f=h.forwardRef((e,t)=>c(v,{...e,_$Gl:t},null==e?void 0:e.children));return f.displayName=v.displayName,f}},20627:(e,t,s)=>{s.d(t,{Te:()=>y});var i=s(96540),n=s(40961);function l(e,t,s){let i,n=s.initialDeps??[];function l(){var l,o,r,h;let a,u;s.key&&(null==(l=s.debug)?void 0:l.call(s))&&(a=Date.now());let d=e();if(!(d.length!==n.length||d.some((e,t)=>n[t]!==e)))return i;if(n=d,s.key&&(null==(o=s.debug)?void 0:o.call(s))&&(u=Date.now()),i=t(...d),s.key&&(null==(r=s.debug)?void 0:r.call(s))){let e=Math.round((Date.now()-a)*100)/100,t=Math.round((Date.now()-u)*100)/100,i=t/16,n=(e,t)=>{for(e=String(e);e.length<t;)e=" "+e;return e};console.info(`%c\u{23F1} ${n(t,5)} /${n(e,5)} ms`,`
            font-size: .6rem;
            font-weight: bold;
...
//# sourceMappingURL=vendors-node_modules_lit-labs_react_index_js-node_modules_tanstack_react-virtual_dist_esm_index_js-8dd97ae67104.js.map